#!/bin/bash
# Script de instalação do sistema Hotspot Inforcenter
...
echo ""
echo "============================================"
echo "   Instalação — Inforcenter Hotspot System"
echo "============================================"
echo ""
...
if [ ! -f backend/.env ]; then
  ...
  echo "  - ADMIN_PASSWORD"
  echo "  - IXC_BASE_URL e IXC_TOKEN (mesmos dados do app do assinante)"
...
pm2 start backend/src/app.js --name "hotspot-inforcenter" --env production
pm2 save
pm2 startup
...
echo ""
echo "   Login padrão: admin / inforcenter@2026"
echo "   (MUDE A SENHA imediatamente!)"
echo ""
echo "   Comandos úteis:"
echo "   pm2 status          — ver status"
echo "   pm2 logs hotspot-inforcenter — ver logs"
echo "   pm2 restart hotspot-inforcenter — reiniciar"
echo "============================================"
